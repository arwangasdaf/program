...
object tt {
  ...
  var webr: Array[(String , (String , String))] = _
  def main(args: Array[String]): Unit = {
      ...
      //从Hbase中读取ABC之间的关系
      //Read.readABC()
      print("PPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPP")
